...
ifeq ($(ROCKSDB_AMTV_VERIFY), 1)
	CXXFLAGS += -DROCKSDB_AMTV_VERIFY
endif
...
amtv_db_refresh_test: $(OBJ_DIR)/db/amtv_db_refresh_test.o $(OBJ_DIR)/test_util/testharness.o $(OBJ_DIR)/test_util/testutil.o $(GTEST) $(LIBRARY)
	$(AM_LINK)
